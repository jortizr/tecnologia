<ul class="space-y-2 font-medium">
    ...
    <li>
        <x-nav-link href="{{-- tu ruta --}}" :active="request()->routeIs('Clausulas.*')">
            <x-heroicon-o-document-text class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-red-700"/>
